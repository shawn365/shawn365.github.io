...
- 목차
	...
	- [3. variables](#3-variables)
	  - [3-1. 변수 선언 방법](#3-1-변수-선언-방법)
	  - [3-2. 변수 이름 법칙](#3-2-변수-이름-법칙)
	- [4. math expressions](#4-math-expressions)
	  - [4-1. 더하기](#4-1-더하기)
	  - [4-2. 빼기](#4-2-빼기)
	  - [4-3. 곱하기](#4-3-곱하기)
	  - [4-4. 나누기](#4-4-나누기)
	  ...
	  - [4-6. 나머지](#4-6-나머지)
	- [5. increment and decrement a number](#5-increment-and-decrement-a-number)
	  - [5-1. increment a number](#5-1-increment-a-number)
	  - [5-2. variables](#5-2-decrement-a-number)
	- [6. advanced math expressions](#6-advanced-math-expressions)
	  - [6-1. \*= ](#6-1-)
	  - [6-2. /=](#6-2-)
	  - [6-3. \*\*;](#6-3-)
	- [7. order of operators](#7-order-of-operators)
	- [8. concatenating text strings](#8-concatenating-text-strings)
	  - [8-1. concatenating text strings](#8-1-concatenating-text-strings)
	  - [8-2. string concatenation](#8-2-string-concatenation)
	- [9. significant whitespace](#9-significant-whitespace)
